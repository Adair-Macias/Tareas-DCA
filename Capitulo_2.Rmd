...
```
Discusión: El tipo de auto que domina corresponde a regular car seguido de van y truck.
...
```
Discusión: Se observa que el tipo de combustible que más se prefiere es aquel que corresponde al eléctico, seguido de la gasolina.
...
```
Discusión: Se observa que el costo por milla recorrida (en decenas de centimos) que es más frecuente, corresponde a alrededor de 4.
...
```
Discusión: Podemos observar cómo dentro de los diferentes segmentos de vehículos la proporción entre una u otra preferencia varía.
Por ejemplo, dentro de los tipos de vehículos: Regcar, sportuv y sportcar, se prefiere la opción 5 en mayor porporción.
...
```
Discusión: Podemos observar cómo dentro de los diferentes segmentos de vcombustibles la proporción entre una u otra preferencia varía.
Por ejemplo, dentro del tipo de combustible: gasoline, se prefiere la opción 5 en mayor porporción.
...
```
Discusión: Podemos observar cómo dentro de los diferentes segmentos de costos la proporción entre una u otra preferencia varía.
Por ejemplo, dentro de los costos por milla recorrida: 6 y 8, se prefiere la opción 5 en mayor porporción.
...
```
Discusión: El diagrama nos muestra que la mayoría de los usuarios que compran un auto regular prefieren la gasolina como combustible, seguido del metanol, y cómo para el primer caso, los lleva a elegir la opción 5 y para el segundo caso la opción 1.
O, por otro lado, cómo aquellos que compran una van prefieren moverse de forma eléctrica a, por ejemplo, con gasolina, inclinandose por la opción 4.